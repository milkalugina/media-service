...
class O_CasesCasePlan extends React.Component {
  constructor(props) {
    super(props);
  ...
  render () {
    return (
      ...
      {this.state.isToggleOn ?
        <div>
        <NAME>
        <A_TypekitH3 name="План дела"></A_TypekitH3>
        ...
        <TEXT><A_TypekitText name="1. Сбор перабатываемых отходов таких как крышки и батарейки"></A_TypekitText><A_TypekitText name="2. Приобщение населения к раздельному сбору мусора, помочь городу в борьбе за экологию"></A_TypekitText>
        <A_TypekitText name="3. Сбор перабатываемых отходов таких как крышки и батарейки"></A_TypekitText></TEXT></div>}
      </DIV>
    );
  }
}
...
export default O_CasesCasePlan
