...
class O_OrgAccountForm extends React.Component {
  render () {
    return (
      <DIV>
      ...
      <DIVTEXTAREA>
        <A_TypekitFilter name="Цели и миссия"></A_TypekitFilter>
        <TEXTAREA name="text" placeholder=" "></TEXTAREA>
      </DIVTEXTAREA>
      <DIVINPUT>
        <A_TypekitFilter name="Website"></A_TypekitFilter>
...
export default O_OrgAccountForm
