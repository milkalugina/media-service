...
class O_VolAccountInfo extends React.Component {
  render () {
    return (
      <DIV>
      <TITLE><A_TypekitTitleS name="Редактирование профиля волонтера"></A_TypekitTitleS></TITLE>
      <IMAGEDIV>
      ...
      <A_TypekitFilter name="Ваш аватар — одна из определяющих частей вашего профиля. Это поможет организаторам составить впечатление о вас."></A_TypekitFilter>
      </IMAGEDIV>
      <DIVINPUT>
        <A_TypekitFilter name="Имя"></A_TypekitFilter>
...
export default O_VolAccountInfo
